// cmd/detkat emits deterministic Falcon/VRF known-answer vectors.
//
// The output is intentionally environment-independent so that Windows,
// Linux, and other builds can be compared byte-for-byte.
package main
